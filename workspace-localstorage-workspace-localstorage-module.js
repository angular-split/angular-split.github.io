(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["workspace-localstorage-workspace-localstorage-module"],{
...
var WorkspaceLocalstorageComponent = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(WorkspaceLocalstorageComponent, _super);
    function WorkspaceLocalstorageComponent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.localStorageName = 'angular-split-ws';
        _this.config = null;
        return _this;
    }
    WorkspaceLocalstorageComponent.prototype.ngOnInit = function () {
    ...
    WorkspaceLocalstorageComponent.prototype.resetConfig = function () {
        this.config = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(defaultConfig);
        localStorage.removeItem(this.localStorageName);
    };
    WorkspaceLocalstorageComponent.prototype.onDragEnd = function (columnindex, e) {
        // Column dragged
        if (columnindex === -1) {
            // Set size for all visible columns
            this.config.columns.filter(function (c) { return c.visible === true; }).forEach(function (column, index) { return (column.size = e.sizes[index]); });
        }
        // Row dragged
        else {
            // Set size for all visible rows from specified column
            this.config.columns[columnindex].rows
                .filter(function (r) { return r.visible === true; })
                .forEach(function (row, index) { return (row.size = e.sizes[index]); });
        }
        this.saveLocalStorage();
    };
    WorkspaceLocalstorageComponent.prototype.toggleDisabled = function () {
        this.config.disabled = !this.config.disabled;
        this.saveLocalStorage();
    };
    WorkspaceLocalstorageComponent.prototype.refreshColumnVisibility = function () {
    ...
    WorkspaceLocalstorageComponent.prototype.saveLocalStorage = function () {
        localStorage.setItem(this.localStorageName, JSON.stringify(this.config));
    };
    WorkspaceLocalstorageComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/*!**********************************************************************************!*\
  ...
  \**********************************************************************************/
/*! exports provided: WorkspaceLocalstorageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkspaceLocalstorageModule", function() { return WorkspaceLocalstorageModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _workspace_localstorage_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./workspace-localstorage.component */ "LpBJ");
...
var WorkspaceLocalstorageModule = /** @class */ (function () {
    function WorkspaceLocalstorageModule() {
    }
    WorkspaceLocalstorageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _ui_ui_module__WEBPACK_IMPORTED_MODULE_5__["UiModule"],
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([{ path: '', component: _workspace_localstorage_component__WEBPACK_IMPORTED_MODULE_6__["WorkspaceLocalstorageComponent"] }]),
                angular_split__WEBPACK_IMPORTED_MODULE_4__["AngularSplitModule"],
            ],
            declarations: [_workspace_localstorage_component__WEBPACK_IMPORTED_MODULE_6__["WorkspaceLocalstorageComponent"]],
        })
    ], WorkspaceLocalstorageModule);
    return WorkspaceLocalstorageModule;
}());
...
//# sourceMappingURL=workspace-localstorage-workspace-localstorage-module.js.map